...
M.on_attach = function(client, bufnr)
	...
	keymap.set("n","<leader>pd", "<cmd>Lspsaga peek_definition<CR>", opts) -- peak definition
	...
	keymap.set("n","<leader>pp", "<cmd>Lspsaga diagnostic_jump_prev<CR>", opts) -- jump to prev diagnostic in buffer
